...
function resolveStudioBaseRoute(studioUrl) {
  ...
  return baseUrl !== "/" && (baseUrl = baseUrl.replace(/\/$/, "")), typeof studioUrl == "string" ? {
    baseUrl
  } : __spreadProps(__spreadValues({}, studioUrl), {
    baseUrl
  });
}
var filterDefault = ({
...
var denylist = /* @__PURE__ */ new Set(["color", "colour", "currency", "email", "format", "gid", "hex", "href", "hsl", "hsla", "icon", "id", "index", "key", "language", "layout", "link", "linkAction", "locale", "lqip", "page", "path", "ref", "rgb", "rgba", "route", "secret", "slug", "status", "tag", "template", "theme", "type", "textTheme", "unit", "url", "username", "variant", "website"]);
function isValidDate(dateString) {
  return /^\d{4}-\d{2}-\d{2}/.test(dateString) ? !!Date.parse(dateString) : false;
}
var allowedProtocols = /* @__PURE__ */ new Set(["app:", "data:", "discord:", "file:", "ftp:", "ftps:", "geo:", "http:", "https:", "imap:", "javascript:", "magnet:", "mailto:", "maps:", "ms-excel:", "ms-powerpoint:", "ms-word:", "slack:", "sms:", "spotify:", "steam:", "teams:", "tel:", "vscode:", "zoom:"]);
...
function stegaEncodeSourceMap(result, resultSourceMap, config) {
  ...
  const report = {
    ...
    return C(
      ...
      {
        origin: "sanity.io",
        href: createEditUrl(__spreadValues({
          baseUrl,
          workspace,
          tool,
          id,
...
//# sourceMappingURL=stegaEncodeSourceMap-CEYTGOBC.js.map
